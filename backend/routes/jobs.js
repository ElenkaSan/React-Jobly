...
router.post("/:id/apply", ensureCorrectUserOrAdmin, async function(req, res, next) {
  try {
...
router.post("/:id/unapplied", ensureCorrectUserOrAdmin, async function(req, res, next) {
  try {
    await Job.unapplied(req.params.id, req.username);
