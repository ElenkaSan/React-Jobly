            ...
            <Form onSubmit={handleSubmit}>
              <FormGroup>
                {hasLoginErrors
                  ...
                  {/* <button type="button" className="close" onClose={() => setHasLoginErrors(true)} dismissible>
               ...
               <Input
                  ...
                  required
                />
                <Button className="btn btn-outline-info" style={{ margin: '2rem', color: '#bfe64b' }} onSubmit={handleSubmit}>Login</Button>
