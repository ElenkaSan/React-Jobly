...
// const ProfileForm = () => {
const ProfileForm = ({ updateUser, resetJobs, setIsUpdate, setProfile }) => {
  const { isLoggedIn, setIsLoggedIn, hasAppliedToJob } = useContext(UserContext);
  const INITIAL_STATE = {
          ...
          <Form onSubmit={handleSubmit}>
            ...
            {hasErrors.length
                 ...
                 {saveConfirmed
                  ...
                  <Button  
                  className="btn btn-outline-info" style={{ color: '#bfe64b' }} 
                  ...
                  <Link className="btn btn-outline-warning float-right" style={{ color: '#1c5752' }}
                   to='/'>
                    Go Back
                  </Link>
            </FormGroup>
